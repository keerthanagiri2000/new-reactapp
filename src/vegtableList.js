export const VegtableList = [
  ...
  },
  {
    ...
    storageUsage:
      "Refrigerate in a loosely sealed plastic bag. It keeps well for upto 7 days. Do not store florets for more than 5 days.Cooked and used in soups, rice, curries, gobi parathas( flat breads), one of the most liked recipes.",
    variableWeight:
      "Please note that the item(s) in this product may vary slightly in size and weight. Hence, the actual weight of the product delivered can have a small variance. You will be billed based on the actual weight during order processing.",
  },
  {
    ...
    name: "Capsicum-Green",
    image:
      "https://us.123rf.com/450wm/spamas/spamas1908/spamas190801343/128346918-green-pepper-full-depth-of-field-on-white-background.jpg?ver=6",
    weight: "500g",
    price: "₹40",
    description:
  ...
  },
  {
    ...
    name: "Cucumber",
    image:
      "https://www.pngitem.com/pimgs/m/51-517098_cool-cucumber-free-vegetables-clipart-fruit-names-a.png",
    weight: "500g",
    price: "₹20",
    description:
    ...
    storageUsage:
      "Wrap the cucumbers tightly in a plastic wrap and store them in the refrigerator. It minimizes decay and keeps it fresh for a long time. Cucumebrs can be eaten fresh. They are a healthy snack to munch on when you are bored. Used in salads, soups, sandwiches, rolls, curries, cocktails and pickles.",
    variableWeight:
      "Please note that the item(s) in this product may vary slightly in size and weight. Hence, the actual weight of the product delivered can have a small variance. You will be billed based on the actual weight during order processing.",
  },
  {
    ...
    name: "Ladies Finger",
    image:
      "https://www.hindimeaning.com/wp-content/uploads/2015/08/Lady_Finger.jpg",
    weight: "500g",
    price: "₹30",
    description:
    ...
    benefits:
      "Ladies finger aids in digestion as it contains prebiotic fiber and controls obesity and cholesterol.It has loaded with Vitamin A, B, C, and traces of Zinc & Calcium.It acts as hair conditioner, fights dandruff and moistures the scalp.",
    storageUsage:
      "Refrigerate them and do not wash them until they are ready to use.Ladies fingers are used in curries, sambhar and can be fried, stuffed and cooked.",
    variableWeight:
      "Please note that the item(s) in this product may vary slightly in size and weight. Hence, the actual weight of the product delivered can have a small variance. You will be billed based on the actual weight during order processing.",
  },
  {
    ...
    name: "Tomato",
    image:
      "https://www.kindpng.com/picc/m/21-214404_fresh-tomato-download-transparent-png-image-fresh-tomatoes.png",
    weight: "1kg",
    price: "₹30",
    description:
  ...
  },
  {
    ...
    name: "Carrot",
    image:
      "https://img.etimg.com/thumb/msid-11581218,width-650,imgsize-15352,,resizemode-4,quality-100/.jpg",
    weight: "1kg",
    price: "60",
    description:
  ...
  },
  {
    ...
    name: "Beans",
    image:
      "https://freshnbox.co.in/pub/media/catalog/product/cache/1fdc0fb500ed8bcf8378aceea4634c50/b/e/beans_1.jpg",
    weight: "1kg",
    price: "₹40",
    description:
      "Green beans are young, unripe fruits of various cultivars of the common bean, although immature or young pods of the runner bean, yardlong bean, and hyacinth bean are used in a similar way. ",
    benefits:
  ...
  },
  {
    ...
    name: "Onion",
    image:
      "https://content3.jdmagicbox.com/comp/jaipur/a6/0141px141.x141.170905155636.s5a6/catalogue/maalibaba-in-vaishali-nagar-jaipur-vegetable-wholesalers-3crms1t.jpg",
    weight: "1kg",
    price: "₹40",
    description:
  ...
  },
  {
    ...
    benefits:
      "Potatoes are rich in starch and carbs, which is important for getting energy.They are also low in calories and laden with vitamins C and B6, manganese, phosphorus, niacin and pantothenic acid.In fact, its skin has more nutrients than the spud itself.",
    storageUsage:
      "Potatoes should always be stored in a cool, dark and dry place.New potatoes are best cooked for slightly longer be it in the pressure cooker or even in the oven.You can roast, grill or char them with the skin on, and then use it in vegetables, gravies or even on its own.Served with coriander and mint tips.",
    variableWeight:
      "Please note that the item(s) in this product may vary slightly in size and weight. Hence, the actual weight of the product delivered can have a small variance. You will be billed based on the actual weight during order processing.",
  },
];
